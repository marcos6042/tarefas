...
paginas = {
    ...
    "Cadastro Filial": ["Empresa", "CNPJ", "Tipo", "Município", "UF", "Inscrição Estadual", "Senha Sefaz", "filiais"],
    ...
    "Nova Tarefa": ["Filial", "Setor", "Subcategoria", "Nome da Tarefa", "Competência", "Vencimento", "Usuário", "tarefas"],
